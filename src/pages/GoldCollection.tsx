...
const GoldCollection = () => {
    ...
    const categories = ['All', ...new Set(goldProducts.map(p => p.category))];

    const filtered = filterCategory === 'All'
        ? goldProducts
        : goldProducts.filter(p => p.category === filterCategory);
    ...
    return (
        <div className="collection-page container">
            <div className="collection-header">
                <div>
                    <h1 className="section-title">Gold Jewellery</h1>
                    <p className="section-subtitle">Explore our finest 22Kt & 18Kt gold masterpieces</p>
                </div>
            </div>
